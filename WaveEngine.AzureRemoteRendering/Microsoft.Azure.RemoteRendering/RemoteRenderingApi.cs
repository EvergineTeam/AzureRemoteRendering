...
namespace Microsoft.Azure.RemoteRendering
{
    ...
    internal enum HandleType : int
    {
        ...
        RenderingSessionPropertiesArrayResult = 4,
        AssetConversionResult = 5,
        AssetConversionStatusResult = 6,
        ObjectBase = 7,
        ComponentBase = 8,
        LightComponentBase = 9,
        CutPlaneComponent = 10,
        HierarchicalStateOverrideComponent = 11,
        PointLightComponent = 12,
        SpotLightComponent = 13,
        DirectionalLightComponent = 14,
        MeshComponent = 15,
        ResourceBase = 16,
        Material = 17,
        PbrMaterial = 18,
        ...
        Entity = 22,
        GraphicsBinding = 23,
        GraphicsBindingSimD3d11 = 24,
        GraphicsBindingWmrD3d11 = 25,
        GraphicsBindingOpenXrD3d11 = 26,
    }
